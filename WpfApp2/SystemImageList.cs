...
namespace WpfApp2
{
    class SystemImageList
    {
        ...
        private const UInt32 LVM_SETIMAGELIST = 4099;
        ...
        public static void SetLVImageList(IntPtr lvwHandle)
        {
            Int32 hRes = ShellAPI.SendMessage(lvwHandle, LVM_SETIMAGELIST, LVSIL_SMALL, m_pImgHandle);
            if (hRes != 0)
                Marshal.ThrowExceptionForHR(hRes);
        }
        #endregion
